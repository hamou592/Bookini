...
<form id="createProviderForm" method="POST" action="/providers"
    ...
    <!-- NAME -->
    <div>
        <input id="nameInput" name="name" placeholder="Provider Name"
    ...
    <!-- PHONE -->
    <div>
        <input id="phoneInput" name="phone" placeholder="Phone"
            class="w-full p-3 border rounded-lg">
...
// 📞 PHONE VALIDATION (optional but clean)
